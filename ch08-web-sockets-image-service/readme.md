### Running `WebSocketsImageApplication` from the command line
```
$ ./gradlew bootRun
```
 - OR
```
$ java -jar ch08-web-sockets-image-service-0.0.1-SNAPSHOT.jar
```

 - [Application](http://localhost:9072/)
 - [Actuator](http://localhost:9072/actuator)
 - [Web Sockets Config for Image Service](http://localhost:9078/image-service/default) 
