package com.giocosmiano.exploration.chapter05;
...
public class DevToolsForSpringBootApplication {

	public static void main(String[] args) {
		SpringApplication.run(DevToolsForSpringBootApplication.class, args);
	}
