package com.giocosmiano.exploration.chapter07.ops;
...
@Component
public class SpringCloudImageHealthIndicator implements HealthIndicator {
	...
	/*
	 ...
	 http://localhost:9072/actuator/health
	 */
	@Override
	public Health health() {
		try {
			URL url =
					new URL("http://localhost:9072/");
